...
/**
 * Precompiled or.example.scala-application-conventions script plugin.
 **/
public class OrExampleScalaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrExampleScalaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("or.example.scala-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrExampleScalaApplicationConventions").asSubclass(BasicScript.class);
